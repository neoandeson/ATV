...
namespace ReportService.ExportExcel
{
    public class EPPlusExport<T> where T : class
    {
        FileInfo newFile;
        ...
        public EPPlusExport(string filePath, string templateFilePath, List<T> list)
        {
        ...
        public bool CreateFileWithTemplate()
        {
            try
            {
                _ErrorMessage = string.Empty;
                ...
                using (xlPackage = new ExcelPackage(newFile, templateFile))
                {
                    ...
                    AddSheetWithTemplate(xlPackage, listData, 1);
        ...
        /// </summary>
        public static void AddSheetWithTemplate(ExcelPackage xlApp, List<T> list, int SheetIndex)
        {
            try
            {
